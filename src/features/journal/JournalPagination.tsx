...
export function JournalPagination({
  ...
  return (
    <div className="mt-16 flex items-center justify-center gap-4 sm:mt-24 sm:gap-8">
      <button
        type="button"
        onClick={() => onPageChange(Math.max(1, currentPage - 1))}
        disabled={currentPage === 1}
        className="group flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-brand-muted transition-all hover:text-brand-ink disabled:opacity-20 sm:gap-3 sm:text-xs sm:tracking-widest"
      >
